...
from cmem_plugin_python.transform import Lifetime
from cmem_plugin_python.workflow import DollyPlugin
...
def setup(request):
    ...
    with io.StringIO("python plugin sample file.") as response_file:
        create_resource(
            project_name=PROJECT_NAME,
